...
\begin{Huge}
    ...
    \begin{center}
        \vspace*{3cm}
        \fontsize{28}{0pt}\selectfont 
        \textbf{MATEMATIKA} \\
        \vspace*{2cm}
        \textbf{KÖZÉPSZINTŰ \\ ÍRÁSBELI VIZSGA} \\
        \vspace*{1cm}
        \fontsize{26}{0pt}\selectfont 
        \textbf{2018. május 8. 8:00 } \\
        \vspace*{1cm}
        \fontsize{34}{0pt}\selectfont 
        \textbf{I.}\\
        \vspace*{1.5cm}
        \fontsize{22}{0pt}\selectfont 
        Időtartam: 45 perc \\
        \vspace*{\fill}
        \fontsize{18}{0pt}\selectfont 
...
% https://tex.stackexchange.com/questions/159257/increase-latex-table-row-height
    ...
    \begin{tabular}{|cl|}
    \hline
    \multicolumn{2}{|M{5cm}|}{Pótlapok száma} \\[2pt]
    \hline
